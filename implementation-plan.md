...
See [docs/testing-strategy.md](./docs/testing-strategy.md) for levels, golden-set policy, and CI commands.
...
Operational detail, calendar guidance, parallel frontend track, and automated gates: **[docs/sequencing-and-effort.md](./docs/sequencing-and-effort.md)**. API: `GET /api/project/sequencing`, `GET /api/project/phases`. CLI: `backend/scripts/check_phase_gates.py`.

---

## 9. Key Risks

Operational detail, verification commands, and code pointers: **[docs/key-risks.md](./docs/key-risks.md)**. API: `GET /api/project/risks`. CLI: `python scripts/check_phase_gates.py --risks`.
...
Copy-paste prompts, docs-first checklist, and verification: **[docs/implementation-prompts.md](./docs/implementation-prompts.md)**. API: `GET /api/project/implementation-prompts` (optional `?phase=N`, `?validate=true`). CLI: `python scripts/check_phase_gates.py --prompts`.
